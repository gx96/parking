...
public class HandleInternalVehicleDelete extends HttpServlet{
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response)
		...
		try {
			...
			PreparedStatement sql=con.prepareStatement(
					"DELETE FROM internal_vehicle WHERE staff_name=?;");//预处理语句
			sql.setString(1,name);//1对应上面的第一个？
		...
		RequestDispatcher dispatcher=
				request.getRequestDispatcher("internalVehicleDelete.jsp");
