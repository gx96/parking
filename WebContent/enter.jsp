...
<jsp:useBean id="enterBean" class="data.Enter" scope="request"/>
<!DOCTYPE html>
<html>
	<head>
		<title>入场登记</title>
	...
	<div class="container">
		...
		<div align="center">
			...
			<table border="1">
				<tr>
					<td colspan=2><jsp:getProperty name="enterBean" property="backNews"/></td>
				</tr>
				<tr>
					<td>车牌号：</td>
					<td><jsp:getProperty name="enterBean" property="plateNumber"/></td>
				</tr>
				<tr>
					<td>入场时间：</td>
					<td><jsp:getProperty name="enterBean" property="enterDate"/></td>
				</tr>
			</table>
		</div>
		 <div class="footer">
