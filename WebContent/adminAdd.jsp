...
<body>
	...
	<jsp:getProperty name="adminBean" property="backNews"/>
		<table border="1" >
			...
			<tr>
				<td align=right>账号：</td>
				<td width="50%"><jsp:getProperty name="adminBean" property="user"/></td>
			</tr>
			<tr>
				<td align=right>密码：</td>
				<td><jsp:getProperty name="adminBean" property="password"/></td>
			</tr>
			<tr>
				<td align=right>工号：</td>
				<td><jsp:getProperty name="adminBean" property="number"/></td>
			</tr>
			<tr>
				<td align=right>姓名：</td>
				<td><jsp:getProperty name="adminBean" property="name"/></td>
			</tr>
			<tr>
				<td align=right>联系电话：</td>
				<td><jsp:getProperty name="adminBean" property="phone"/></td>
			</tr>
		</table>
	</div>
	<div class="footer">
