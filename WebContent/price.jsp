...
<jsp:useBean id="priceBean" class="data.Price" scope="request"/>
...
<body>
	<div class="container">
		...
		<div class="sidebar1">
		  ...
		  <table border="1" style="margin-top:20px">
		  		<tr>
					<td colspan="2">当前收费信息:</td>
				</tr>
				<tr>
					<td align=center>计时单位</td>
					<td align=center>单位金额</td>
				</tr>
				<%
				  try{
				   ...
				   Statement sql = con.createStatement();
					ResultSet rs=sql.executeQuery("select unit,unit_sum from fee_scale");
					rs.next();
				%>
				<tr>
	...
	<div align=center>
		<form action="priceServlet" method="post">
			<table border="1">
				<tr>
					<td align=right>计时单位：</td>
					<td><input type="text" name="unit"></td>
				</tr>
				<tr>
				<tr>
					<td align=right>单位金额：</td>
					<td><input type="text" name="unitSum"></td>
				</tr>
				<tr>
