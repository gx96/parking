		...
		<div class="container">
			...
			<table border="1" style="margin-top:20px">
				...
				<%
				  try{
				   ...
				   Statement sql = con.createStatement();
					ResultSet rs=sql.executeQuery("select plate_number,enter_date,out_date from history_vehicle where to_days(out_date) = to_days(now())");
				...
				<tr>
					...
					<td align=center><%= dateChange(rowSet.getTimestamp(2)) %></td>
