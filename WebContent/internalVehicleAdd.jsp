...
<body>
	...
	<div align=center>
		<form action="addInternalVehicleServlet" method="post">
			<table border="1">
				<tr>
	...
	<jsp:getProperty name="vehicleBean" property="backNews"/>
		<table border="1" >
			<tr>
				<td colspan=2 align="center">车主信息</td>
			</tr>
			<tr>
				<td align=right>教职工号：</td>
				<td><jsp:getProperty name="vehicleBean" property="staffNumber"/></td>
			</tr>
			<tr>
				<td align=right>车主姓名：</td>
				<td><jsp:getProperty name="vehicleBean" property="staffName"/></td>
			</tr>
			<tr>
				<td align=right>车牌号：</td>
				<td><jsp:getProperty name="vehicleBean" property="plateNumber"/></td>
			</tr>
		</table>
	</div>
	<div class="footer">
